...
public class UserControllerTest {
    ...
    UserModel mockUserModel = new UserModel(0,"Cristian", "123456789", "7777",
                                            1, "cesaineam", "en bogota", "el " +
                                                    "pass",
                                            LocalDateTime.parse("2020-09-30T10:11:30"), "0-");
    UserModel mockUserModel1 = new UserModel("Esteban", "987654321", "9999",
                                             1, "cesteban", "en bogota1", "el" +
                                                     " pass1",
                                             LocalDateTime.parse("2020-09-30T10:11:50"), "0+");
    String expected = "[{idUser:0,name:\"Cristian\",document:\"123456789\",phone:\"7777\",userUniversity:1,mail:\"cesaineam\",address:\"en bogota\",password:\"el pass\",registryDatetime:\"2020-09-30T10:11:30\",Rh:\"0-\"}]";
    ...
    public void testCreate() throws Exception {
        String exampleJson = "{\"name\":\"Cristian\"," +
                ...
                "\"userUniversity\":1,\"mail\":\"cesaineam\",\"address\":\"en" +
                " bogota\",\"password\":\"el pass\"," +
                "\"registryDatetime\":\"2020-09-30@10:11:30\",\"rh\":\"0-\"}";
